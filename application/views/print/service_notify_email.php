...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                : <a href="http://support.innostellar.info/pages/service_detail/<?= $service->service_invoice ?>">http://support.innostellar.info/pages/service_detail/<?= $service->service_invoice ?></a>
            </td>
        </tr>
    </table>
