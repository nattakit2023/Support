        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <h3><strong>จัดการPort</strong></h3>
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">จัดการPort</li>
...
<script>
    ...
    $(document).on('click', '#EditPort', function() {
        ...
        let port_names = $('#edit_port_names').val();

        let port_provinces = $('#edit_port_provinces').val();
